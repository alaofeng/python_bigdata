...
def main(keywords, url):
    ...
    bs4_visitor = Bs4Visitor(browser, keywords=keywords)
    ...
    def to_keyword(self, keyword):
        ...
        if keyword:
            self.browser.ExecuteJavascript('''
                                ...
                                ''' % (keyword,))
    #进入下一页，可能有三种情况：1、没有查询结果 2、已经达到最后一页 3、正常跳转到下一页
    #
...
if __name__ == '__main__':
    #pdb.run('main()')
    keywords = (u'大数据', u'大数据架构师', u'大数据技术总监', u'技术总监', u'cto', u'技术合伙人', u'大数据讲师', u'python', u'java', u'前端', u'架构师',u'技术专家',)
    #url = "https://www.zhipin.com/tianjin"
    url = "https://www.zhipin.com/beijing"
    main(keywords=keywords, url=url)
    url = "https://www.zhipin.com/tianjin"
    main(keywords=keywords, url=url)
    print('main exit')
    sys.exit(100)
